    ...
    <div style={{
      ...
      >
        <CardHeader style={{
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', margin: 0 }}>Iniciar Sesión</h1>
          <p style={{ color: 'var(--color-texto-secundario)', fontSize: '0.875rem', margin: 0 }}>
            Ingresa a tu cuenta para chatear
          </p>
        </CardHeader>
        <CardBody style={{ padding: '1.5rem 2rem 2rem' }}>
          <form onSubmit={manejarSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <p style={{
              ...
              ¿No tienes cuenta?{' '}
              <Link href="/registro" style={{ color: 'var(--color-acento)', fontWeight: '500' }}>
                Regístrate
              </Link>
            </p>
          </form>
